...
namespace PHP.Core.Lang.Lexic.Token
{
    public static class TokenQueue
    {
        private static readonly TokenType[] queue = new TokenType[]
        {
            ...
            TokenType.T_YIELD_FROM,                 //  yield from
            ...
            //  TokenType.T_UNSET,                    //  unset()
            //  TokenType.T_EMPTY,                    //  empty()
            //  TokenType.T_EVAL,                     //  eval()
            //  TokenType.T_EXIT,                     //  exit() die()
            //  TokenType.T_HALT_COMPILER,            //  __halt_compiler()
            //  TokenType.T_ISSET,                    //  isset()
            //  TokenType.T_LIST,                     //  list()
            //  TokenType.T_PRINT,                    //  print()
            //  TokenType.T_ARRAY,                      //  array()
            //  TokenType.T_INLINE_HTML,              //  any text outside php code tags
            //  TokenType.T_BAD_CHARACTER, \n (0x0a) и \r (0x0d)
        };
